...
myEchartRect.setOption(RectOption);
    ...
    render () {
        return (
            <>
                <div id="pieCharts" ref ={this.PieRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
                <div id="LineCharts" ref ={this.LineRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
                <div id="RectCharts" ref ={this.RectRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
            </>  
        )
    }
}
