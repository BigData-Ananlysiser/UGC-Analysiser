...
class CapitalBudget extends React.Component {
    ...
    componentDidMount() {
        const myEchart = Echarts.init(document.getElementById('pieChart'), halloween);
        const option = {
                        title: {
                            text: '某站点用户访问来源',
                            left: 'left',
                        ...
                        series: [
                            {
                                ...
                                emphasis: {
                                    itemStyle: {
                                        ...
                                        textStyle: {
                                            fontSize: this.PieRef.current.offsetWidth/1082*1
                                        }
                                    }
                                }
        ...
        const myEchartLine = Echarts.init(document.getElementById('LineChart'), halloween);
        const LineOption = {
            title: {
                text: '堆叠区域图',
                textStyle: {
        ...
        const myEchartRect = Echarts.init(document.getElementById('RectChart'), halloween);
        const xAxisData = [];
        const data1 = [];
        const data2 = [];
        for (let i = 0; i < 30; i++) {
...
myEchartRect.setOption(RectOption);
    ...
    render () {
        return (
            <>
                <div id="pieChart" ref ={this.PieRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
                <div id="LineChart" ref ={this.LineRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
                <div id="RectChart" ref ={this.RectRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
            </>  
        )
    }
}
...
// import './comm.less';
// // import { makingPieChart, getEchartsInfo, makingColumnChart, makingLineChart } from './comm.js'
// // 引入 ECharts 主模块
// import echarts from 'echarts';
...
//     componentDidMount () {
//         const Echarts = echarts.init(document.getElementById('pieChart'), halloween);
//         this.setState({
//             myEchart: Echarts
//          })
//         Echarts.setOption()
...
//         return (
//             <>
//                 <div id="pieChart" ref ={this.LineRef} className="common_Echarts" style={{height:400, marginBottom: 20}}></div>
//             </>
//         )
//     }
// }

// export default LeftAssembly;
